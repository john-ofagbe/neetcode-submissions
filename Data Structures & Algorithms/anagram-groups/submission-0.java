class Solution {
    /*
        ...
        2. count the number of characters present in each string
        3. put this data into a hashmap
        4. iterate through the input strings and check for string length match
           4a. if length does not match, continue with the iteration
           4b. if length match, check for number of characters present in the hashmap
    */
